...
interface WechatyEventEmitter {
    on: <E extends keyof WechatyEventListeners>(
        event: E,
        listener: WechatyEventListeners[E]
    ) => WechatyInterface
    off: <E extends keyof WechatyEventListeners>(
        event: E,
        listener: WechatyEventListeners[E]
    ) => WechatyInterface
    once: <E extends keyof WechatyEventListeners>(
        event: E,
        listener: WechatyEventListeners[E]
    ) => WechatyInterface
}
